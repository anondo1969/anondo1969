...
- [**serve-template-gradio**](https://github.com/ScilifelabDataCentre/serve-template-gradio): programmatic access, MCP, and agent workflows for [SciLifeLab Serve](https://serve.scilifelab.se/) apps
