...
- [**serve-template-gradio**](https://github.com/ScilifelabDataCentre/serve-template-gradio): AI agent & CLI access, MCP, and agent workflows for SciLifeLab Serve apps
